"""neondrv_19675 URL Configuration
...
admin.site.site_header = "neondrv"
admin.site.site_title = "neondrv Admin Portal"
admin.site.index_title = "neondrv Admin"

# swagger
api_info = openapi.Info(
    title="neondrv API",
    default_version="v1",
    description="API documentation for neondrv App",
)
